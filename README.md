...
The **Power Index Rank Gap** is a derived feature calculated from the country's Power Index rank.
...
For example, if a country's Power Index rank is 5, the calculated Power Index Rank Gap is 4.

This derived metric is used in the dashboard analysis to represent the adjusted position based on the country's Power Index rank.
