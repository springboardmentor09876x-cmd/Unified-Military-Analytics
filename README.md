...
Open the dashboard file (dashboard/Military_Dashboard_ALL_4_Integrated.pbix) in Tableau Desktop or Tableau Public.
If prompted, point the data source to data/military_final.xlsx.
Use the filters and parameters on each dashboard page to explore the data.
Navigate between dashboard pages using the on-screen navigation buttons.
Hover over any chart element to view detailed tooltips.
