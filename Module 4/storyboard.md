...
- **Header**: Main title "GLOBAL MILITARY ANALYTICS - GOSHEN ROBERT" and a collapsible sidebar button (`☰`).
...
- **KPI Row (4 Cards)**:
  ...
  - **Total Global Assets**
  - **Top Power Index**
    _Each card features a unique neon glowing top-border (pink, cyan, yellow, purple) and text shadow._
- **Charts Row**:
  - **KPI Chart**: Budget to GDP Ratio.
  - **Donut Charts**: Top 5 Countries by Purchasing Power Parity, Military Assets, Naval Fleet, Air Fleet, Land Fleet, and Defence Budget.
...
The Final hosted app in Netlify to be opened in pc: "https://infosys-global-military-analysis-gosh.netlify.app/"
